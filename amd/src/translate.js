...
function process_notes() {
    ...
    $("#process-notes").on('click', function () {
        ...
        $('#fakesmarts-translation-container').html('<i class="fa fa-spinner fa-spin fa-3x fa-fw"></i><span class="sr-only">...</span>');
        ...
        gpt_response[0].done(function (result) {
            ...
            setTimeout(function () {
                ...
                $('#fakesmarts-translation-container').html(data.message);
