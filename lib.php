 ...
 */
function local_fakesmarts_navdrawer_items()
{
    global $CFG;
...
//    ];
    ...
    if (has_capability('local/fakesmarts:view_models', $context)) {
        $items[] = navdrawer::add(
    ...
    if (has_capability('local/fakesmarts:view_bot_types', $context)) {
        $items[] = navdrawer::add(
    ...
    if (has_capability('local/fakesmarts:view_bots', $context)) {
        $items[] = navdrawer::add(
            get_string('bots', 'local_fakesmarts'),
            null,
