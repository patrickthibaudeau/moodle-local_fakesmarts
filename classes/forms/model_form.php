...
class model_form extends \moodleform
{
    ...
    protected function definition()
    {
        ...
        $mform->addElement(
            'text',
            'azure_api_version',
            get_string('azure_api_version', 'local_fakesmarts')
        );
        $mform->setType(
            'azure_api_version',
            PARAM_TEXT
        ...
        $mform->addElement(
            ...
            get_string('azure_deployment_name', 'local_fakesmarts')
        );
        $mform->setType(
            'azure_deployment_name',
            PARAM_TEXT
        ...
        $mform->addElement(
            'text',
            'model_name',
            get_string('model_name', 'local_fakesmarts')
        );
        $mform->setType(
            'model_name',
            PARAM_TEXT
        ...
        $mform->addElement(
            'text',
            'prompt_cost',
            get_string('prompt_cost', 'local_fakesmarts')
        );
        $mform->setType(
            'prompt_cost',
            PARAM_FLOAT
        ...
        $mform->addElement(
            'text',
            'completion_cost',
            get_string('completion_cost', 'local_fakesmarts')
        );
        $mform->setType(
            'completion_cost',
            PARAM_FLOAT
